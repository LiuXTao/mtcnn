...
MODLE_STORE_DIR = os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/mtcnn_pytorch/model_store"

ANNO_STORE_DIR = os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/mtcnn_pytorch/anno_store"

TRAIN_DATA_DIR = os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/mtcnn_pytorch/train"

LOG_DIR = os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/mtcnn_pytorch/log"
